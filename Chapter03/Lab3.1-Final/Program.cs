...
namespace ContainerDevice
{
    class Program
    {
        ...
        private static string dpsIdScope = "<ID Scope>";
        // Registration ID
        private static string registrationId = "<Registration ID>";
        // Individual Enrollment Primary Key
        private const string individualEnrollmentPrimaryKey = "<Individual Enrollment Primary Key>";
        // Individual Enrollment Secondary Key
        private const string individualEnrollmentSecondaryKey = "<Individual Enrollment Secondary Key>";
